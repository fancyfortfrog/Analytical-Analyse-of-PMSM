...
for num_phase= 1:12
    for ti = 1:1000
        ...
        if ismember(num_phase,[1,2,3,4])
            I_phase(ti,num_phase)=I_phase_max*sin(wr*t+theta0-(num_phase-1)*pi/12);
        elseif ismember(num_phase,[5,6,7,8])
            I_phase(ti,num_phase)=I_phase_max*sin(wr*t+theta0-(num_phase-5)*pi/12-2*pi/3);
        elseif ismember(num_phase,[9,10,11,12])
            I_phase(ti,num_phase)=I_phase_max*sin(wr*t+theta0-(num_phase-9)*pi/12+2*pi/3);
        end
    end
end
...
filename1="E:\multi_phase_shift_angle\differente_Br\FEA_Br_15_0.6.csv";
filename2="E:\multi_phase_shift_angle\differente_Br\FEA_Bt_15_0.6.csv";
...
filename3="E:\multi_phase_shift_angle\differente_Br\FEA_Fr_15_0.6.csv";
filename4="E:\multi_phase_shift_angle\differente_Br\FEA_Ft_15_0.6.csv";
